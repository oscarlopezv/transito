        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <form class="max-w-7xl mx-5 p-4" @submit.prevent="form.post(route('user.store'))">
                        <div class="grid grid-cols-3 gap-6">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" id="name" v-model="form.password"  name="name" class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base " required>
                            </div>
                        </div>                    
